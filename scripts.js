document.addEventListener("DOMContentLoaded", function() {
  ...
  const messageInput = document.getElementById("message-input"); // Adicionado o elemento do campo de mensagem
  ...
  messageInput.addEventListener("keydown", function(event) {
    if (event.key === "Enter") {
      event.preventDefault(); // Evitar a quebra de linha padrão
      sendMessage();
    }
  });
});
